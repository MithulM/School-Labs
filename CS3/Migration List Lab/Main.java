/* Main class used to test MigrationList
...
public class Main
{
  public static void main(String[] args)
  {
    ...
    if (newLeader != null && newLeader.equals(expected))
    ...
    expected = flock.get(2);
    if (weakest != null && weakest.equals(expected))
    ...
    if (splitFlock != null)
    {
      ...
      System.out.println("in reverse: " + splitFlock.reverseString());
    }
    else
